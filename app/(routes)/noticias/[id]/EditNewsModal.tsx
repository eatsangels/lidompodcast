...
const EditNewsModal = ({ isOpen, onClose, news, onEditSuccess }: EditNewsModalProps) => {
    const [isLoading, setIsLoading] = useState(false);
    const [embedUrl, setEmbedUrl] = useState<string | null>(null);
     const { register, handleSubmit, reset, watch, setValue, formState: { errors } } = useForm<NewsFormData>();
